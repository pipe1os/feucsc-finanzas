...
export default function AdminFilters({
 ...
 >
 <Select.Trigger className="rounded-xl border border-border bg-zinc-50 text-sm h-9 min-h-0 items-center **:data-[slot=select-value]:truncate **:data-[slot=select-value]:text-sm">
 <Select.Value>
 {({ isPlaceholder, state }) => {

...
export default function AdminMobileList({
 ...
 <div className="flex size-12 items-center justify-center rounded-full bg-gray-50 text-gray-400 border border-border shadow-xs">
 <SearchIcon />
 </div>
 ...
 <span className="font-semibold text-sm text-gray-900 tabular-nums shrink-0">
 {formatCLP(g.monto)}
 </span>
 </div>

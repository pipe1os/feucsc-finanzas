...
export function ExpenseTableFilters({
 ...
 focus:border-red-300 focus:bg-surface focus:ring-2 focus:ring-red-100 h-9"
 ...
 >
 <Select.Trigger className="rounded-xl border border-gray-200 bg-gray-50 text-sm h-9 min-h-0 items-center **:data-[slot=select-value]:truncate **:data-[slot=select-value]:text-sm">
 <Select.Value>
 {({ isPlaceholder, state }) => {

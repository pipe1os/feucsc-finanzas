...
function NavItem({
 ...
 className="absolute left-0 top-1/2 -translate-y-1/2 h-5 w-0.5 rounded-full bg-red-500/70"
 />
 )}
...
function NavCategory({ label }: { label: string }) {
 return (
 <span className="px-3 pb-2 pt-1 text-[10px] font-medium tracking-widest text-gray-500 uppercase">
 {label}
 </span>
 );
}

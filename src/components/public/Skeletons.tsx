...
export function SkeletonKPICards() {
 return (
 <div className="rounded-2xl border border-zinc-100 bg-white shadow-apple p-6 sm:p-8 h-full flex flex-col">
...
export function SkeletonChart({
 ...
 if (type ==="category") {
 return (
 <div className="h-full flex flex-col rounded-2xl border border-zinc-100 bg-white p-6 shadow-apple overflow-hidden gap-y-4">
 <Skeleton className="h-5 w-40 rounded-lg" />
